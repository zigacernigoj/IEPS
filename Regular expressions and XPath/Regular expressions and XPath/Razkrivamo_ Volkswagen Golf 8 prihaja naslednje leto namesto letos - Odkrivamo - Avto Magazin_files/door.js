    ...
    if (window.DotMetricsInitScript == undefined) {
        ...
        var imgUrl = "http://script.dotmetrics.net/hit.gif?id=1776&url=" + pageUrl + "&dom=" + domain + "&r=" + rand;
                    ...
                    window.DotMetricsSettings =
                                {
                                    ...
                                    ScriptDebugUrl:  "http://demo-script.dotmetrics.net/Scripts/script.debug.js?v=d242d26e-cc14-4941-bf7f-a2c6cc112d15",
